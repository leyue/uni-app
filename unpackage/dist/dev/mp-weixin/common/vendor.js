...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.color = void 0;var color = {
  turquoise: '#00be9c',
  green_sea: '#01a185',
  emerald: '#1fcf6d',
  nephritis: '#1aaf5d',
  ...
  light_dark: '#646464',
  demo: '#FF4081' };exports.color = color;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.func = void 0;var func = {
...
var _detail = __webpack_require__(/*! ./detail */ 20);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default);

var store = new _vuex.default.Store({
  modules: { detail: _detail.detail } });var _default =
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.detail = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance");}function _iterableToArrayLimit(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var detail = {
  ...
  mutations: {
    setErr: function setErr(state, err) {
      state.err = err;
    },
    setApp: function setApp(state, app) {
      state.app = app;
    },
    setPro: function setPro(state, pro) {
      state.pro = pro;
    },
    setIns: function setIns(state, ins) {
      state.ins = ins;
    },
    setDocs: function setDocs(state, docs) {
      state.docs = docs;
    },
    setOnlineStatus: function setOnlineStatus(state, status) {
      state.onlineStatus = status;
    },
    setOfflineStatus: function setOfflineStatus(state, status) {
      state.offlineStatus = status;
    } },

  actions: {
    setApp: function () {var _setApp = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref, app) {var commit, state, _ref2, _ref3, err, res, docs, status, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, doc, pro, ins;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit, state = _ref.state;_context.prev = 1;_context.next = 4;return (

                  uni.request({
                    url: "http://nats-sh.unisoc.com:30001/app/uni/task/".concat(app),
                    method: 'GET' }));case 4:_ref2 = _context.sent;_ref3 = _slicedToArray(_ref2, 2);err = _ref3[0];res = _ref3[1];if (!

                err) {_context.next = 11;break;}
                commit('setErr', err.toString());return _context.abrupt("return");case 11:


                docs = res.data;if (!(
                docs.length == 0)) {_context.next = 15;break;}
                commit('setErr', '不存在!');return _context.abrupt("return");case 15:


                status = 'passed';_iteratorNormalCompletion = true;_didIteratorError = false;_iteratorError = undefined;_context.prev = 19;
                ...
                }_context.next = 27;break;case 23:_context.prev = 23;_context.t0 = _context["catch"](19);_didIteratorError = true;_iteratorError = _context.t0;case 27:_context.prev = 27;_context.prev = 28;if (!_iteratorNormalCompletion && _iterator.return != null) {_iterator.return();}case 30:_context.prev = 30;if (!_didIteratorError) {_context.next = 33;break;}throw _iteratorError;case 33:return _context.finish(30);case 34:return _context.finish(27);case 35:
                doc = docs[0];
                ...
                commit('setPro', pro);
                commit('setIns', ins);
                commit('setDocs', docs);_context.next = 48;break;case 45:_context.prev = 45;_context.t1 = _context["catch"](1);

                commit('setErr', _context.t1);case 48:case "end":return _context.stop();}}}, _callee, this, [[1, 45], [19, 23, 27, 35], [28,, 30, 34]]);}));function setApp(_x, _x2) {return _setApp.apply(this, arguments);}return setApp;}() },



  getters: {
    proIns: function proIns(state) {
      var proIns = [];
      var value = 0;var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {var _loop = function _loop() {var _step2$value = _slicedToArray(_step2.value, 2),
          idx = _step2$value[0],item = _step2$value[1];
          var pro = item.element.project;
          if (
          proIns.find(function (item, idx) {
          ...
          var children = [];
          var childValue = 0;var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
            for (var _iterator3 = state.docs.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var _step3$value = _slicedToArray(_step3.value, 2),subIdx = _step3$value[0],subItem = _step3$value[1];
              if (subItem.element.project !== state.pro) {
                continue;
              }
              var ins = subItem.element.instrument ?
          ...
          value++;};for (var _iterator2 = state.docs.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var _ret = _loop();if (_ret === "continue") continue;
        }
        // console.log(proIns);
    ...
    doc: function doc(state) {
      function formartCase(cases, status) {
        ...
        function prehandle(module, category) {
          ...
          for (var _iterator4 = cases.entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {var _step4$value = _slicedToArray(_step4.value, 2),idx = _step4$value[0],item = _step4$value[1];
            var module = item.module;
            var category = item.category;
            switch (status) {
              case '*':
                prehandle(module, category);
                data[module][category].push(_objectSpread({}, item, { idx: idx }));
                break;
              case 'confirm':
                if (
              ...
              case 'ongoing':
                ...
                {
                  prehandle(module, category);
                  data[item.module][category].push(_objectSpread({}, item, { idx: idx }));
                }
                break;}
      ...
      var doc = null;var _iteratorNormalCompletion5 = true;var _didIteratorError5 = false;var _iteratorError5 = undefined;try {
        for (var _iterator5 = state.docs.entries()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {var _step5$value = _slicedToArray(_step5.value, 2),idx = _step5$value[0],item = _step5$value[1];
          var pro = item.element.project;
          var ins = item.element.instrument ? item.element.instrument : '*';
      ...
      } catch (err) {_didIteratorError5 = true;_iteratorError5 = err;} finally {try {if (!_iteratorNormalCompletion5 && _iterator5.return != null) {_iterator5.return();}} finally {if (_didIteratorError5) {throw _iteratorError5;}}}return doc;
...
/***/ 7:
/*!***************************************************!*\
  !*** D:/home/uni_app/pages.json?{"type":"style"} ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!**************************************************!*\
  !*** D:/home/uni_app/pages.json?{"type":"stat"} ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__3711EAB" };exports.default = _default;
...
var _color = __webpack_require__(/*! ../common/color */ 10);
var _func = __webpack_require__(/*! ../common/func */ 11);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

_vue.default.prototype.$color = _color.color;
_vue.default.prototype.$func = _func.func;
